...
AND H.name_id = (
  SELECT N.name_id
  FROM Names_ AS N
  WHERE N.name_ LIKE 'Emma June' AND N.birth_year = 1964)
ORDER BY T.start_year ASC;
...
WHERE T.primary_title LIKE 'Pulp Fiction'
AND T.title_type LIKE 'movie'
AND T.title_id = H.title_id
...
FROM Titles AS T, Title_ratings AS R
WHERE T.primary_title REGEXP '^James Bond.*'
...
-- Query 21
-- What were the episodes of Game of Thrones?
...
-- Query 22
-- What were the names and average ratings of each episode of Breaking Bad?
...
-- Query 23
-- What was the most popular episode of Breaking Bad?
...
-- Query Q24
-- How many episodes were there in Breaking Bad per season? And what was the average of the average episode ratings ?
